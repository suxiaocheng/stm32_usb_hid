...
/** @defgroup STM32L152D_EVAL_LCD_Private_Function_Prototypes
  * @{
  */
static void Convert(uint8_t * c, Point_Typedef Point,
...
/**
  ...
  * @retval None
  */
void LCD_GLASS_DisplayChar(uint8_t * ch, Point_Typedef point,
			   DoublePoint_Typedef DoublePoint, uint8_t position)
{
	/*!< Wait Until the last LCD RAM update finish */
	while (LCD_GetFlagStatus(LCD_FLAG_UDR) != RESET) {
...
/**
  ...
  * @retval None
  */
void LCD_GLASS_ScrollString(uint8_t * ptr, uint16_t nScroll,
...
/**
  ...
  * @retval None
  */
void LCD_GLASS_WriteMatrixPixel(PixelRow_TypeDef PixelRow,
...
/**
  ...
  * @retval None
  */
void LCD_GLASS_ClearMatrixPixel(PixelRow_TypeDef PixelRow,
				PixelColumn_TypeDef PixelColumn)
{
	/*!< Wait Until the last LCD RAM update finish */
	while (LCD_GetFlagStatus(LCD_FLAG_UDR) != RESET) {
...
static void LCD_GPIOConfig(void)
{
	...
	GPIO_InitStructure.GPIO_Pin =
	    GPIO_Pin_2 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11 |
