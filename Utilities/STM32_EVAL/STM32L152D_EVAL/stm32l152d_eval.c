...
void SD_LowLevel_Init(void)
{
	...
	RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOC | RCC_AHBPeriph_GPIOD |
...
void SD_LowLevel_DMA_TxConfig(uint32_t * BufferSRC, uint32_t BufferSize)
{
	...
	DMA_ClearFlag(SD_SDIO_DMA_FLAG_TC | SD_SDIO_DMA_FLAG_TE |
		      SD_SDIO_DMA_FLAG_HT | SD_SDIO_DMA_FLAG_GL);
...
void LM75_LowLevel_Init(void)
{
	...
	GPIO_PinAFConfig(LM75_I2C_SCL_GPIO_PORT, LM75_I2C_SCL_SOURCE,
			 LM75_I2C_SCL_AF);

	/* Connect PXx to I2C_SDA */
	GPIO_PinAFConfig(LM75_I2C_SDA_GPIO_PORT, LM75_I2C_SDA_SOURCE,
			 LM75_I2C_SDA_AF);

	/* Connect PXx to I2C_SMBUSALER */
	GPIO_PinAFConfig(LM75_I2C_SMBUSALERT_GPIO_PORT,
			 LM75_I2C_SMBUSALERT_SOURCE, LM75_I2C_SMBUSALERT_AF);
