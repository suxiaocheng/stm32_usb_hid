...
__IO uint16_t ADC1ConvertedValue = 0, ADC1ConvertedVoltage =
    0, calibration_value = 0;
...
void ADC_Configuration(void)
{
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_31, 1,
	...
	ADC_RegularChannelConfig(ADC1, ADC_AIN_CHANNEL, 1,
