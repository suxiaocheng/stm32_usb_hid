...
void CEC_Init(CEC_InitTypeDef * CEC_InitStruct)
{
	...
	assert_param(IS_CEC_SIGNAL_FREE_TIME
	...
	assert_param(IS_CEC_BIT_RISING_ERROR
  ...
  /*---------------------------- CEC CFGR Configuration ----------------------*/
	...
	tmpreg |=
	    (CEC_InitStruct->CEC_SignalFreeTime | CEC_InitStruct->
	     CEC_RxTolerance | CEC_InitStruct->
	     CEC_StopReception | CEC_InitStruct->
	     CEC_BitRisingError | CEC_InitStruct->
	     CEC_LongBitPeriodError | CEC_InitStruct->
	     CEC_BRDNoGen | CEC_InitStruct->CEC_SFTOption);
