...
uint32_t COMP_GetOutputLevel(uint32_t COMP_Selection)
{
	...
	if ((*(__IO uint32_t *) (COMP_BASE + COMP_Selection) &
	     (COMP_CSR_COMPxOUT))
	    != 0) {
